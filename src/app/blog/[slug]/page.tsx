...
export default async function BlogPostPage({
  ...
  // Convert blog post to news-compatible format for schema
  const schemaPost = {
    title: post.title,
  ...
  return (
    <>
      ...
      />
      <JsonLd data={articleSchema(schemaPost)} />
        ...
        <div className="container-max">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-accent/5 border-l-4 border-accent rounded-r-lg p-6 mb-10">
              <p className="text-lg text-navy-400 italic leading-relaxed">
                &ldquo;{post.genZHook}&rdquo;
              </p>
            </div>
              ...
              {post.content.map((paragraph, index) => {
                ...
                if (paragraph.startsWith("- ")) {
                  return (
                    <li
                      key={index}
                      className="text-lg leading-relaxed text-gray-700 ml-6 mb-2 list-disc"
                    >
                      {paragraph.slice(2)}
                    </li>
                  );
            ...
            <div className="bg-gray-50 rounded-xl p-6 md:p-8 flex flex-col sm:flex-row items-start gap-5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">
                  Evidence-based policy for a smarter Australia
                </p>
                <p className="text-gray-600 text-sm mt-3 leading-relaxed">
                  Not left. Not right. Empirical. We follow the evidence wherever
                  it goes, even when it&apos;s uncomfortable.
                </p>
              </div>
            </div>
        ...
        <div className="relative section-padding">
          <div className="container-max text-center max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Enough Talk. Let&apos;s Fix This.
            </h2>
            <p className="text-white/80 text-lg mb-8 leading-relaxed">
              Join a movement of Australians who are sick of career politicians
              and ready for evidence-based policy.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/join" className="btn-cta px-8 py-4 text-lg">
                Join the Party
              </Link>
              <Link href="/blog" className="btn-outline px-8 py-4 text-lg">
                More Articles
              </Link>
            </div>
          </div>
