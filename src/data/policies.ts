...
export const policies: Policy[] = [
  ...
  },
  {
    ...
    summary:
      "Climate change is real and potentially civilisation-ending. Humans have largely given up on fixing it. Renewables and EVs were never going to be enough. So why not let AI have a go?",
    icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    description: [
      "Climate change is real. It is driven by human activity. It is potentially civilisation-altering. And humans have, for all practical purposes, given up on fixing it.",
      "That's not hyperbole. The US has withdrawn from the Paris Agreement — again. Corporations worldwide are quietly abandoning their carbon neutrality pledges. Germany shut down its nuclear plants and went back to coal. As physicist Sabine Hossenfelder documented in February 2026: 'It seems clear that we have given up on trying to stop climate change.' She's right. And as she noted, what's most alarming isn't the climate change itself — it's what it reveals about our collective inability to make intelligent decisions about long-term threats.",
      "The renewables-and-EVs story was always more marketing than physics. Net zero by 2050 is not a realistic goal — most plans to achieve it are fuelled by wishful thinking rather than rational analysis. Electric vehicle grid requirements are decades behind schedule. The IPCC's own carbon removal assumptions have been called 'unrealistic and potentially dangerous' by researchers at the University of Melbourne. Fossil fuels still produce almost two-thirds of global electricity. Solar and wind together produce about 10%. The maths doesn't work on current trajectories, and everyone quietly knows it.",
      "Here's what nobody in politics will say: addressing climate change requires genuine sacrifice across every economy on Earth — reduced consumption, redirected investment, constrained growth in some sectors, and massive resource transfers from wealthy nations to developing ones. No politician in any democracy will say this because voters don't elect people who promise sacrifice. And market economies have no mechanism to price in the survival of civilisation — externalities that play out over decades and centuries are invisible to quarterly earnings.",
      "So humans have tried and failed. The coordination problem is too complex, the political incentives too perverse, the time horizons too long for democratic cycles. Fine. So why not give AI a go? Not as a replacement for human decision-making, but as a mediator, modeller, and broker capable of operating at the scale and complexity the problem actually demands.",
      "The climate problem is fundamentally a coordination problem across 195 nations with wildly different economic interests, development stages, and political systems. Current mechanisms — the Paris Agreement, carbon trading schemes, bilateral deals — have failed because they rely on voluntary compliance with no enforcement, and because no human institution can model the cascading interactions between energy systems, agriculture, trade, demographics, and climate feedback loops across the entire planet simultaneously. AI can. We propose developing AI systems capable of modelling global economic-climate interactions at a granularity no human institution has achieved — tracking real-time emissions, supply chains, energy grids, deforestation, and ocean chemistry across every nation. These systems could dynamically calculate fair carbon prices that account for each nation's development stage, historical emissions, and economic capacity. They could mediate carbon credit markets that actually work — not the current system where companies pay to plant trees that may never grow while continuing to emit. They could model the true cost of inaction in terms that markets understand, and propose trade-weighted carbon border adjustments that don't simply punish developing nations for being poor.",
      ...
      "This is not techno-utopianism. AI won't fix climate change by itself. But humans have demonstrably failed to fix it by themselves. Every international agreement, every corporate pledge, every government target has either been abandoned, watered down, or simply ignored. At some point you have to look at the track record and try something different. AI is the first tool sophisticated enough to mediate global economic coordination at the scale climate change actually requires. We've tried human diplomacy, market mechanisms, and international law. They haven't worked. What exactly do we have to lose?"
    ],
    keyPoints: [
      "State the truth: climate change is real, human-caused, and potentially civilisation-ending. Humans have largely given up on fixing it. No equivocation, no culture war, no denial — including denial about our own failure",
      "Acknowledge the failure: renewables and EVs alone won't solve this. Net zero by 2050 is fantasy. Every major international agreement has been abandoned or ignored. The scale of sacrifice required has been systematically understated because politicians know voters won't accept it",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "No, it's realism. Techno-utopianism says 'technology will save us without sacrifice.' We're saying the opposite: massive sacrifice is required, humans have proven unable to coordinate it, and AI might be the tool that makes coordination possible. The Paris Agreement failed. Corporate pledges have been abandoned. Government targets are being walked back worldwide. At what point do we admit the current approach isn't working and try something new? AI doesn't eliminate the need for sacrifice — it helps figure out how to share it fairly across 195 nations with competing interests. That's a logistics problem, and AI is very good at logistics."
      },
      {
